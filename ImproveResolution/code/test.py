...
def main(opt):
    ...
    if not os.path.exists(SAVE_PATH + "/predcited/"):
        os.makedirs(SAVE_PATH + "/predcited/")
    ...
    for file in file_list:
        ...
        out_renormal = np.squeeze(out.numpy(),axis = (0,1))
        save_h5(out_renormal,SAVE_PATH + "/predcited/" + file)
    cal_metric(sr_path = SAVE_PATH + "/predcited/",hr_path = TEST_TARGET_PATH,save_path = SAVE_PATH)
