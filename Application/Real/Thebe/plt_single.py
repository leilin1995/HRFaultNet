...
def show_result_single():
    ...
    fault_Faultseg = read_hdf5("Thebe_Faultseg.hdf5", internal_path="predict")
    fault_Swin = read_hdf5("Thebe_Swin.hdf5", internal_path="predict")
    ...
    plt.imshow(seismic_raw.T, cmap=plt.cm.gray, vmin=-1.6, vmax=1.65)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_sr.T, cmap=plt.cm.gray, vmin=-1.6, vmax=1.65)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_raw.T, cmap=plt.cm.gray, vmin=-1.6, vmax=1.65)
    plt.imshow(fault_Faultseg.T, cmap="jet", vmin=0.15, vmax=0.85, alpha=fault_Faultseg.T)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_raw.T, cmap=plt.cm.gray, vmin=-1.6, vmax=1.65)
    plt.imshow(fault_Swin, cmap="jet", vmin=0.15, vmax=0.85, alpha=fault_Swin)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_raw.T, cmap="seismic", vmin=-1.6, vmax=1.65)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_sr.T, cmap="seismic", vmin=-1.6, vmax=1.65)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
