...
def show_result():
    ...
    ax1.imshow(seismic_raw.T,cmap=plt.cm.gray,vmin=-7.5,vmax=7.5)
    ax1.set_ylabel("Samples",font1)
    ax1.set_title("Traces", font1)
    ax1.text(-12, -14,"(a)",font1)

    ax2 = fig.add_subplot(gs[0:20, 32:62])
    ax2.imshow(seismic_raw.T,cmap=plt.cm.gray,vmin=-7.5,vmax=7.5)
    ...
    ax3.imshow(seismic_sr.T,cmap=plt.cm.gray,vmin=-7.5,vmax=7.5)
    ax3.set_ylabel("Samples",font1)
    ax3.text(-24, -28,"(c)",font1)

    ax4 = fig.add_subplot(gs[24:44, 32:62])
    ax4.imshow(seismic_sr.T, cmap=plt.cm.gray,vmin=-7.5,vmax=7.5)
