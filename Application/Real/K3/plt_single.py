...
def show_result_single():
    ...
    fault_Faultseg = read_hdf5("K3_FaultSeg.hdf5", internal_path="predict")
    fault_Swin = read_hdf5("Kerry3D_Swin.hdf5", internal_path="predict")
    ...
    plt.imshow(seismic_raw.T, cmap=plt.cm.gray, vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_sr.T, cmap=plt.cm.gray, vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_raw.T, cmap=plt.cm.gray, vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    plt.imshow(fault_raw, cmap="jet", vmin=0.15, vmax=0.85, alpha=raw_alpha)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_raw.T, cmap=plt.cm.gray, vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    plt.imshow(fault_Faultseg, cmap="jet", vmin=0.15, vmax=0.85, alpha=faultseg_alpha)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_raw.T, cmap=plt.cm.gray, vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    plt.imshow(fault_Swin, cmap="jet", vmin=0.15, vmax=0.85, alpha=faultswin_alpha)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    plt.savefig("./fig/fault_Swin.png", dpi=300, bbox_inches="tight")

    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_sr.T, cmap=plt.cm.gray, vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    plt.imshow(fault_sr, cmap="jet", vmin=0.15, vmax=0.85, alpha=sr_alpha)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_raw.T, cmap="seismic", vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
    ...
    plt.figure(figsize=(6, 6))
    plt.imshow(seismic_sr.T, cmap="seismic", vmin=-7.5 * 1.5, vmax=7.5 * 1.5)
    # plt.ylabel("Samples", font)
    # plt.title("Traces", font)
    # plt.text(-12, -14,"(a)",font1)
